    ...
    <>
        ...
        <MapContainer center={mapcenter} zoom={mapZoom} maxZoom={25} scrollWheelZoom={true} className='varad'>
          ...
          <FullscreenControlWrapper position="topright"/>
            ...
            <LeafletDrawComponent2 featureGrpRef={featureGrpRef} setShowDataAddingDailogue={setShowDataAddingDailogue} setClickedLayerId={setClickedLayerId} setDrawnLayerInfoMap={setDrawnLayerInfoMap} drawnLayerInfoMap={drawnLayerInfoMap}/>
