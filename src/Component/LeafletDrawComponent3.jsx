...
function LeafletDrawComponent3({featureGrpRef, setShowDataAddingDailogue, setClickedLayerId, setDrawnLayerInfoMap, drawnLayerInfoMap}) {
...
export default LeafletDrawComponent3;
